    ...
    <div className="flex justify-between items-center p-4 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          <Link to="/login">
            <img className="w-7 cursor-pointer" src={assets.profileIcon} />
          </Link>

          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
            <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-400 rounded-md">
        ...
        <Link to="/cart" className="relative">
          <img src={assets.cartIcon} className="w-7 min-w-7" />
      ...
      >
        <div className="flex flex-col text-gray-600">
          ...
          >
            <img className="h-4 rotate-90" src={assets.dropdownIcon} alt="" />
            <p>Back</p>
          </div>
          <NavLink
            onClick={() => setVisible(false)}
